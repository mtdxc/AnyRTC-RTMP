...
namespace webrtc {
  ...
  public:
    AudioPcm(const void* audioSamples, size_t nSamples,
      ...
      int size = nSamples * sizeof(int16_t) * nChannels;
      audio_samples_ = new char[size];
      memcpy(audio_samples_, audioSamples, size);
...
void A_AACEncoder::clear_audio_buffer() {
